...
public:
	...
	virtual bool IsTickable() const override { return bInitialized && GetWorld() != nullptr; }
...
private:
	...
	/** Only tick between Initialize and Deinitialize : the CDO and not-yet-initialized instances have no world */
