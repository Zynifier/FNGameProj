...
float UFortRuntimeOptions::GetHPMicrophoneToastDisplaySeconds() {
    return 0.0f;
}
...
UFortRuntimeOptions::UFortRuntimeOptions() {
    ...
    bEnableItemDefinitionWhiteListing = false;
    bEnableItemDefinitionWhiteListingForTransientPickups = false;
    bAlwaysReadyUpAllLocalPlayersForMatchmaking = false;
    bEnableSpeculativeCreativeMMTeamSizeFix = false;
    bForceDisallowAnonymousMode = false;
    bForcePRM = false;
    bCreativeUseOnlyIslandVolumeForEdit = false;
    bCreativeEnableTimerForPhoneToolEnforcement = false;
    bEnableSocialTab = false;
    bOnlyShowPartyAssistQuestsInSocialTab = false;
    bShowCompletedSocialQuestsCalloutIfApplicable = false;
    bAllowSocialPresenceUpdates = false;
    bEnableToastSocialWidget = false;
    bEnableINICachedSocialStatus = false;
    MaxINICachedSocialStatuses = 0;
    MinSecondsBetweenINICachedSocialStatuses = 0.0;
    bEnableSocialMovieBG = false;
    bShowRMTDescriptionPopup = false;
    bAllowJuniorEndingMovie = false;
    bAllowCreativeModeratorMode = false;
    CreativeHeatmapThermometerCellSize = 0.0f;
    bEnableRequestToJoin = false;
    bAnyPartyMemberAllowedToCancelMatchmakingV2 = false;
    bShowBattlePassBangs = false;
    bEnableMultidivisionTournamentEventIdQuorum = false;
    bUseAircraftStartTimeForTimeAliveTournamentStat = false;
    bSaveToCloudOnSuspend = false;
    bSaveToCloudOnDeactivate = false;
    bSaveToCloudOnTerminate = false;
    bSaveToCloudOnExit = false;
    bSaveToCloudOnLogout = false;
    bOverrideCreativeQuickbarFocusOnToggle = false;
    MaxStackSizeForCreativeResources = 0;
    bDisableAccoladesButton = false;
    bAllowPreserveSquadMemberVoting = false;
    bKeepPlayingTogether = false;
    bEnableGFNSettingEditCondition = false;
    bEnableMipsCapExperiment = false;
    CurrentMipsCapExperimentVersion = 0;
    bEnableDownloadAnalyticsReporting = false;
    bEnableDownloadHeartbeat = false;
    DownloadHeartbeatIntervalInSeconds = 0.0f;
    bCrossplayOptInByDefault = false;
    bUseClientSettingsForControllerImage = false;
    RadioTuningRetryTime = 0.0f;
    RadioTuningRetryCount = 0;
    BattleStarsNeededToShowRewardPreview = 0;
    bEnableUEKGameSelect = false;
    bCompletelyDisableUEKGameSelect = false;
    bAlwaysPlayBPVideo = false;
    bDisableGRL = false;
    PlatformChatToastDisplaySeconds = 0.0f;
    HPMicrophoneToastDisplaySeconds = 0.0f;
    MaxCharactersInTextEntry = 0;
    bUseToxicityAsCreativeMainTextSanitizer = false;
    KeepPlayingTogetherDuration = 0.0f;
    KeepPlayingTogetherTickFrequency = 0.0f;
    bCreativeMapRenderingInHub = false;
    bCreativeMapWaitForVolumeReady = false;
    EOneVideoLength = 0.0f;
    MaxNumberOfMediaDecoderResources = 0;
    bEnableLoadingScreenPIP = false;
    MinInteractionScoreForFriendToBeConsideredClose = 0;
    MinIntervalBetweenInviteToPartyNotificationsInSeconds = 0;
    DelayBetweenStartOfPostGameAndShowDelayedNotificationsInSeconds = 0.0f;
    bEnableSidekickFeature1 = false;
    bEnableSidekickFOMO = false;
    bEnableSidekickAvatars = false;
    bSidekickDisablesScreenRecord = false;
    bSidekickEnableExitFNButton = false;
    bEnableSidekickFaceAreaInvalidation = false;
    bSidekickDisabledByNightNight = false;
    bSidekickForcesSingleChannelMode = false;
    bAllowSimultaneousChannelConnections = false;
    bAllowSimultaneousChannelListening = false;
    bExpandNotListeningChannels = false;
    bEnableItemShopDynamicBackground = false;
    bEnableCrew = false;
    bEnableSubscriptionInspectScreen = false;
    InGameCosmeticItemBangRefreshRate = 0.0f;
    bShouldAllowNightNightMode = false;
    bEnableDADUpdateCheckOnRTMM = false;
    bShouldAllowForcedIntro = false;
    bShowMovieInGameplayIntro = false;
    bShowMovieInGameplayOutro = false;
    bSkipSubgameSelectDuringForcedIntro = false;
    bSkipToEndGameplayIntroOutroVideos = false;
    bExplicitSprintableInputRange = false;
    MinForwardForSprintSnapping = 0.0f;
    AccelerationStrafeMultiplierSprintOverride = 0.0f;
    KeyboardDiagonalSprintForwardOverride = 0.0f;
    KeyboardSprintInputWindUpTime = 0.0f;
    KeyboardMoveInputWindUpTime = 0.0f;
    bEnableWebAuthFNMobileOnClassicBuild = false;
    bPortraitWebAuthFNMobileOnClassicBuild = false;
    bBacchusFrontendLabelShown = false;
    NoWeaponZoneMaxDestroyCount = 0;
    NoWeaponZoneResetDestroyCountRate = 0.0f;
    bAllowCurieIfCreativeOrPlayground = false;
    bEnableServerSendPlayerInteractions = false;
    ServerSendPlayerInteractionsIntervalSeconds = 0.0f;
    bEnableServerSendPlayerInteractionsRankInCreativeMode = false;
    bEnableFrontendMeshRockyRidgeCheck = false;
    FrontendMeshRockyRidgeInitialIntervalSeconds = 0.0f;
    FrontendMeshRockyRidgeFailureMultiplier = 0.0f;
    FrontendMeshRockyRidgeMaxIntervalSeconds = 0.0f;
    bForceEverybodyToGoNightNight = false;
    bQueryKeychainBeforeGoingNightNight = false;
    bAllowSubgameSelectToGoNightNight = false;
    bAllowAthenaFrontendToGoNightNight = false;
    bAllowCampaignFrontendToGoNightNight = false;
    bGyroV2Enabled = false;
    bFlickStickEnabled = false;
    bEnableBacchusDialogSystem = false;
    bBacchusDialogSystemSkipConfirmationStep = false;
    bMobileDisableResolutionReset = false;
    bMotionAxisMobileDefaultToYaw = false;
    bShouldRestartCreativeServersForCalendarEventChanges = false;
    bCreativeEmoteControllerUseWhitelist = false;
}
